...
const About = () => {
    return (
        <>
            <div id="home"></div>
            <section className='min-h-[40vh] flex items-center justify-center px-4 sm:px-6 lg:px-8 relative overflow-hidden w-full' id='about'>
                    ...
                    >
                        <div className='space-y-2'>
                            ...
                            <p className='text-lg text-slate-400 max-w-xl mx-auto lg:mx-0 leading-relaxed pt-2'>
                                Frontend and Django Developer with 1+ year of frontend development experience and 8 months of Django backend experience. Skilled in building scalable web applications.
                            </p>
                        </div>
